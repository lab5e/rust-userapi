...
/// Update the team. You must be an administrator of the team to edit it.
pub async fn generate_invite(configuration: &configuration::Configuration, team_id: &str, body: crate::models::RequestInviteDetails) -> Result<crate::models::Invite, Error<GenerateInviteError>> {
...
pub async fn update_member(configuration: &configuration::Configuration, team_id: &str, user_id: &str, body: crate::models::MemberOfATeam) -> Result<crate::models::Member, Error<UpdateMemberError>> {
...
/// Update the team. You must be an administrator of the team to edit it.
pub async fn update_team(configuration: &configuration::Configuration, team_id: &str, body: crate::models::ATeam) -> Result<crate::models::Team, Error<UpdateTeamError>> {
